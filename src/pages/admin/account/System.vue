...
<template>
  ...
  <div>
      ...
      <el-form :inline="true" :model="form" class="demo-form-inline">
        ...
        <el-form-item>
          <el-select v-model="form.type" placeholder="请选择类型" clearable>
            ...
            <el-option label="体现" value="体现"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item>
    ...
    <el-table :data="tableData" border style="width: 100%">
      ...
      <el-table-column prop="description" label="描述" align="center"></el-table-column>align="center"
    </el-table>
    <!-- 分页 -->
...
export default {
  ...
  methods: {
    ...
    async queryTableData() {
      ...
      let res = await pageQuerySystemAccount(temp);
      // console.log(res);
